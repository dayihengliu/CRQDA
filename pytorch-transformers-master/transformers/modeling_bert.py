...
class BertModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, position_ids=None,
                head_mask=None, inputs_embeds=None, encoder_hidden_states=None, encoder_attention_mask=None, output_embedding=False, fixed_embedding=None):
        ...
        if fixed_embedding is None:
            ...
            embedding_output = fixed_embedding
        ...
        if output_embedding:
            outputs = outputs + (embedding_output,)
