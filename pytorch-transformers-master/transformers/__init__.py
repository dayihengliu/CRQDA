...
from .data import (is_sklearn_available,
                   ...
                   squad_convert_examples_to_features, SquadFeatures, squad_convert_examples_to_features_cg, squad_convert_examples_to_features_wiki,
                   SquadExample, SquadV1Processor, SquadV2Processor, WikiProcessor)
...
if is_torch_available():
    ...
    from .modeling_gpt2 import (GPT2PreTrainedModel, GPT2Model,
                                GPT2DecLMHeadModel, GPT2DecModel,
    ...
    from .modeling_roberta import (RobertaForMaskedLM, RobertaModel,
                                ...
                                RobertaForQuestionAnsweringClassify, RobertaForQuestionAnsweringClassifyCLS,
