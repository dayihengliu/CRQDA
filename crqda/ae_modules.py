...
class EncoderDecoder(nn.Module):
    ...
    def __init__(self, encoder, decoder, gru, src_embed, tgt_embed, generator, input_size):#, vocab_size=50265, id_pad=1):
    ...
    def decode(self, memory, tgt, tgt_mask):
        ...
        src_mask = torch.ones(memory.size(0), 1, 1).long().cuda()
        #print("src_mask here", src_mask)
        #print("src_mask", src_mask.size())
        return self.decoder(self.tgt_embed(tgt), memory, src_mask, tgt_mask)

    def greedy_decode(self, latent, max_len=64, start_id=0):
        '''
